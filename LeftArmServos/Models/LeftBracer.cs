...
namespace LeftArmServos.Models
{
    public class LeftBracer
    {
        ...
        private double _rocketCurrentAngle;
        private double _outerPanelCurrentAngle;
        private double _innerPanelCurrentAngle;
        ...
        public void Initialise()
        {
            ...
            {
                if (((GpioButton)sender).IsPressed)
                {
                    Open();
                }
                else
